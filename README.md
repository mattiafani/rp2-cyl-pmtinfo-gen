...
<p align="center">
  ...
  <em>Lateral surface, Detector size: r = 3.2 m, H = 5.4 m; PMT radius = 254.0 mm. Shown: 77 PMTs over 104 total PMTs, 40% coverage</em>
</p>

<p align="center">
  <img src="docs/images/small_detector/02_open_top_bot_R3200.0_H5400.0_CIRC.png" width="600" alt="r = 3200 mm, H = 5400 mm"><br>
<img src="docs/images/small_detector/02_open_top_bot_R3200.0_H5400.0_GRID.png" width="600" alt="r = 1690 mm, H = 3620 mm"><br>
  <em>Comparison on the two endcap styles. Detector size: r = 16.9 m, H = 36.2 m; PMT radius = 254.0 mm. Shown: 2x22 PMTs over 104 total PMTs, 40% coverage</em>
</p>
